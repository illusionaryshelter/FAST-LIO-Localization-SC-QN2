...
// ===== This example shows how to use fastlio_nanoflann with these types of
// containers: =======
...
/** A simple vector-of-vectors adaptor for fastlio_nanoflann, without
 * duplicating the storage. The i'th vector represents a point in the state
 * space.
 *
...
struct KDTreeVectorOfVectorsAdaptor {
  ...
  typedef fastlio_nanoflann::KDTreeSingleIndexAdaptor<metric_t, self_t, DIM,
                                                      IndexType>
      index_t;
